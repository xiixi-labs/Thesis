...
export default function SignInPage() {
    return (
        <div className="min-h-screen bg-[#fbfbfd] flex flex-col justify-center items-center relative overflow-hidden p-6 gap-8">
            ...
            <div className="pointer-events-none absolute right-[-10rem] bottom-[-10rem] h-[40rem] w-[40rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(236,72,153,0.1),rgba(255,255,255,0)_60%)] blur-[90px]" />
            ...
            <div className="z-10 flex flex-col items-center gap-4">
                ...
                <p className="text-zinc-500 text-sm">Welcome back to your knowledge base.</p>
            </div>
