...
export const ThesisBackground = ({ children, className = "" }: { children: React.ReactNode; className?: string }) => (
    <div className={`relative w-full overflow-hidden bg-[#fbfbfd] text-zinc-950 ${className}`}>
        ...
        <div
            className="pointer-events-none absolute left-[-20%] top-[-10%] h-[25rem] w-[25rem] md:left-[-20%] md:top-[-15%] md:h-[55rem] md:w-[55rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(99,102,241,0.55),rgba(255,255,255,0)_65%)] blur-[80px] md:blur-[120px]"
            style={{ animation: 'blob-float 25s ease-in-out infinite' }}
        />
        <div
            className="pointer-events-none absolute left-[5%] top-[5%] h-[20rem] w-[20rem] md:left-[5%] md:top-[15%] md:h-[40rem] md:w-[40rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(236,72,153,0.55),rgba(255,255,255,0)_65%)] blur-[70px] md:blur-[110px]"
            style={{ animation: 'blob-float-alt 20s ease-in-out infinite 2s' }}
        />
        <div
            className="pointer-events-none absolute right-[-10%] top-[20%] h-[22rem] w-[22rem] md:right-[-15%] md:top-[5%] md:h-[48rem] md:w-[48rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.55),rgba(255,255,255,0)_65%)] blur-[70px] md:blur-[110px]"
            style={{ animation: 'blob-float 22s ease-in-out infinite 4s' }}
        />
        <div
            className="pointer-events-none absolute bottom-[-5%] right-[5%] h-[24rem] w-[24rem] md:bottom-[-20%] md:right-[10%] md:h-[50rem] md:w-[50rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.55),rgba(255,255,255,0)_65%)] blur-[75px] md:blur-[115px]"
